  ...
  return (
    <main className="min-h-screen bg-slate-950 flex items-center justify-center px-6">
      <div className="w-full max-w-md bg-slate-900/50 border border-slate-800 rounded-3xl p-10">
        ...
        <p className="text-slate-500 text-sm mb-8">Sign in to your NextRide account</p>
        ...
        <p className="text-slate-500 text-sm mt-6 text-center">
          ...
          <Link href="/register" className="text-blue-400 hover:underline font-bold">Register</Link>
        </p>
      </div>
    </main>
  );
